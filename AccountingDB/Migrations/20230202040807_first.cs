    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankUsers", x => new { x.UserId, x.BankId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionMetas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransactionMetas_Metas_MetaId",
                        column: x => x.MetaId,
                        principalTable: "Metas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionMetas_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionMetas_MetaId",
                table: "TransactionMetas",
                column: "MetaId");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionMetas_TransactionId",
                table: "TransactionMetas",
